...
const rotasSemTour = [
  '/login', '/cliente/login', '/profissional/login',
  '/cliente/cadastro', '/profissional/cadastro', '/profissional/aguardando',
  '/change-password', '/acesso-negado', '/ajuda',
  '/totem', '/salas', '/reagendar',
]
