import { CalendarClock, Check, DoorOpen, Plus, UserCog } from 'lucide-react'
...
import { CreateUserAccount } from '../../features/users/CreateUserAccount'
...
export function Settings() {
  // This page is also the Gerente's (/recepcao/configuracoes), and creating accounts is administrator
  // only — showing the card to a manager would offer a form the API always refuses.
  const administrator = useSession().user?.roles.includes('ADMINISTRADOR') ?? false
