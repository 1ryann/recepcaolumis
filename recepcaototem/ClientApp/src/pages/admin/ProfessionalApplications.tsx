...
import { professionalRegistrationApi, type ProfessionalApplicationDto, type ProfessionalApplicationStatus } from '../../api/modules'
import { EmptyState } from '../../components/PageElements'

const statusBadge: Record<ProfessionalApplicationStatus, { tone: string, label: string }> = {
  PENDING: { tone: 'pending', label: 'Pendente' }, APPROVED: { tone: 'approved', label: 'Aprovada' }, REJECTED: { tone: 'rejected', label: 'Recusada' },
}
