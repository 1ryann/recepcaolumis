...
// routes to the code-based check-in or to the professional carousel. Renting a room is not
// offered here: whoever is at the kiosk came to be seen, and renting belongs to the public
// landing page at `/`, where someone looking for a room actually arrives. No QR field and no
// code input live here; those belong to `/totem/check-in`. Both options are real <button>
