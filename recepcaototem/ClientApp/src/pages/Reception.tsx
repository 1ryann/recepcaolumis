    ...
    <main className={`reception-shell ${step === 'select' ? 'rynex-select-shell' : ''}`}>
      {step === 'select' ? <section className="lumis-gallery reception-fade">
        ...
        <div className="lumis-gallery-actions">
          ...
          <a className="lumis-gallery-customer" href="/profissional/login"><UserRound size={21} /><span><strong>Área do profissional</strong></span><ArrowRight size={19} /></a><a className="lumis-gallery-customer" href="/cliente/login"><UserRound size={21} /><span><small>Para quem já tem cadastro</small><strong>Área do cliente</strong></span><ArrowRight size={19} /></a>
