...
public sealed class RescheduleTokenConfiguration : IEntityTypeConfiguration<RescheduleToken>
{
    public void Configure(EntityTypeBuilder<RescheduleToken> entity)
    {
        entity.ToTable("RescheduleTokens");
        ...
        entity.HasIndex(x => x.ReservationId).IsUnique().HasDatabaseName("UX_RescheduleTokens_ReservationId");
        entity.HasIndex(x => x.TokenHash).IsUnique().HasDatabaseName("UX_RescheduleTokens_TokenHash");
